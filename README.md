...
2. У каждой карты есть своя механика и стоимость в эликсире.
3. Разыгрывать можно по одной карте за раз, пока позволяет общий запас эликсира.
4. У каждого игрока свой запас эликсира.
5. Эликсир накапливается автоматически, максимум 10.
