...
V. Распространение (app -> Google Play, info -> YouTube, запасной вариант -> Boosty/Patrion)
...
├── modules/
│   ├── __init__.py
│   ├── all_card.py        # Все карты
│   ├── card_maneger.py    # Управление циклом карт противника
│   ├── game_state.py      #
